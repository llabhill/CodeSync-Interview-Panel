...
function MeetingRoom() {
    ...
    const callingState=useCallCallingState()//tells whether u joined meeeting or not
  ...
  return (
    ...
    {/* //firstly we r having moving layout in meeting room
    //and other one in coding panel */}
    <ResizablePanelGroup direction='horizontal'>
        ...
        {/* //below component  is for moving the panel */}
